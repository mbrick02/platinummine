...
<div class="w3-card-4">
    ...
    <form class="w3-container" action="<?= $form_location ?>" method="post">
        ...
        <p>
            <label class="w3-text-dark-grey"><b>Item Color</b></label>
            <input type="text" name="item_color" value="<?= $item_color ?>" class="w3-input w3-border w3-sand" placeholder="Enter Item Color">
        </p>
        <p> 
            <?php 
