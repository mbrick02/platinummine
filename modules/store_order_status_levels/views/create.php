...
<div class="w3-card-4">
    ...
    <form class="w3-container" action="<?= $form_location ?>" method="post">
        ...
        <p>
            <label class="w3-text-dark-grey"><b>Order Status Title</b></label>
            <input type="text" name="order_status_title" value="<?= $order_status_title ?>" class="w3-input w3-border w3-sand" placeholder="Enter Order Status Title">
        </p>
        <p> 
            <?php 
